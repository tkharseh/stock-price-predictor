...
def perform_lstm(ticker):
    ...
    response = data_fetcher.load_stock_data('./data/stock_price_data.csv', up_to_date=True, request=requests)
...
# lstm_model.fit(Xtrain_step, Ytrain_step, epochs=50, validation_data=(
